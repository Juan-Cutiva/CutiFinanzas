              ...
              <label className="flex cursor-pointer items-start gap-2 text-sm">
                ...
                <span>
                  ...
                  <span className="block text-xs text-muted-foreground">
                    El cambio aplica solo a {monthLabel}. Los demás meses siguen con el monto actual
                    del presupuesto recurrente.
                  </span>
                </span>
              </label>
              <label className="flex cursor-pointer items-start gap-2 text-sm">
                ...
                <span>
                  ...
                  <span className="block text-xs text-muted-foreground">
                    Los meses pasados conservan su valor original. Desde {monthLabel} en adelante se
                    usa el nuevo monto.
                  </span>
                </span>
              </label>
